...
DROP MATERIALIZED VIEW IF EXISTS source_summary CASCADE;
DROP MATERIALIZED VIEW IF EXISTS channel_summary CASCADE;
...
DROP MATERIALIZED VIEW IF EXISTS payment_summary CASCADE;
